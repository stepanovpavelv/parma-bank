...
public class SpringFoxConfig implements WebMvcConfigurer {
    ...
    private static final String APP_NAME = "Swagger (money transfer)";
    private static final String DESCRIPTION = "Application for user's bank accounts and manipulating with them";
